    ...
    return Drawer(
      child: ListView(
        ...
        children: <Widget>[
          ...
          ListTile(leading: Icon(Icons.party_mode, color: Colors.blue), title: Text('Party Mode'), onTap: () {}),
          ListTile(leading: Icon(Icons.people, color: Colors.blue), title: Text('People'), onTap: () {}),
          ListTile(
